// fantasy forest theme specific configuration
// No shared imports - each theme has its own complete config

// fantasy forest-specific reel configurations
export const reelStrips = [
    // Reel 1 (fantasy forest configuration)
...
// fantasy forest-specific multipliers (defined completely within this theme)
export const symbolNumberMultipliers = {
    0: { 3: 75, 4: 250, 5: 1500 }, // Higher jackpot for fantasy forest Sun God
    1: { 3: 20, 4: 75, 5: 500 },   // Better payouts for fantasy forest Mask
    2: { 3: 15, 4: 50, 5: 200 },   // fantasy forest Totem
    3: { 3: 10, 4: 25, 5: 100 },   // fantasy forest Calendar
    4: { 3: 5, 4: 15, 5: 50 }      // fantasy forest Pattern
};

// fantasy forest-specific paylines
export const PAYLINES = [
    ...
    [2, 1, 2, 1, 2]  // Zigzag bottom - two extra paylines for fantasy forest theme
];

// fantasy forest-specific payout rules
export const PAYOUT_RULES = {
    minWinLength: 3, // Minimum symbols in a row for a win
    scatterPayouts: {
        3: 8,  // 3 scatters pays 8x bet (higher scatter pays for fantasy forest)
