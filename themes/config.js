...
export const symbolNumberMultipliers = {
    0: 2,  // Symbol number 0 (e.g., Seven in Classic) pays 10x base
    1: 1,   // Symbol number 1 (e.g., Bell in Classic) pays 5x base
    2: 0.5,   // Symbol number 2 (e.g., Bar in Classic) pays 4x base
    3: 0.2,   // Symbol number 3 (e.g., Lemon in Classic) pays 3x base
    4: 0.1    // Symbol number 4 (e.g., Cherry in Classic) pays 2x base
};
